...
all: unit-tests omni-infra-provider-proxmox image-omni-infra-provider-proxmox lint
...
.PHONY: $(ARTIFACTS)/omni-infra-provider-proxmox-linux-amd64
$(ARTIFACTS)/omni-infra-provider-proxmox-linux-amd64:
	@$(MAKE) local-omni-infra-provider-proxmox-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: omni-infra-provider-proxmox-linux-amd64
omni-infra-provider-proxmox-linux-amd64: $(ARTIFACTS)/omni-infra-provider-proxmox-linux-amd64  ## Builds executable for omni-infra-provider-proxmox-linux-amd64.

.PHONY: $(ARTIFACTS)/omni-infra-provider-proxmox-linux-arm64
$(ARTIFACTS)/omni-infra-provider-proxmox-linux-arm64:
	@$(MAKE) local-omni-infra-provider-proxmox-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: omni-infra-provider-proxmox-linux-arm64
omni-infra-provider-proxmox-linux-arm64: $(ARTIFACTS)/omni-infra-provider-proxmox-linux-arm64  ## Builds executable for omni-infra-provider-proxmox-linux-arm64.

.PHONY: omni-infra-provider-proxmox
omni-infra-provider-proxmox: omni-infra-provider-proxmox-linux-amd64 omni-infra-provider-proxmox-linux-arm64  ## Builds executables for omni-infra-provider-proxmox.
...
.PHONY: image-omni-infra-provider-proxmox
image-omni-infra-provider-proxmox:  ## Builds image for omni-infra-provider-proxmox.
	@$(MAKE) registry-$@ IMAGE_NAME="omni-infra-provider-proxmox"

run-integration-test: omni-infra-provider-proxmox
